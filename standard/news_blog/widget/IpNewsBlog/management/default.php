<div class="ipaStream">
    ...
    <select name="stream" class="ipAdminInput">
...
<div class="ipaTitleLevel">
    ...
    <select name="titleLevel" class="ipAdminInput">
...
<div class="ipaShowReadMore">
    ...
    <input type="checkbox" name="showReadMore" class="ipAdminInput" <?php echo isset($showReadMore) && (int)$showReadMore ? 'checked="checked"' : ''; ?>" />
</div>
<div class="ipaPagination">
    ...
    <input type="checkbox" name="pagination" class="ipAdminInput" <?php echo isset($pagination) && (int)$pagination ? 'checked="checked"' : ''; ?>" />
</div>
